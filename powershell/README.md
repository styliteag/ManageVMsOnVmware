...
./migrate_datastore.ps1 --Server ***REMOVED*** --Username $USER --Pwd $PASS --DestinationDatastore ***REMOVED*** --SourceDatastore ***REMOVED*** --PoweredOff --ExcludeVMs 'unused|delete|test|off_' --vMotionLimit 2 --DryRun
